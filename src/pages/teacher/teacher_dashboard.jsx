...
function TeacherDashboard() {
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-10 min-h-screen overflow-y-auto scrollable-container">
      {/* Welcome banner */}
      <section className="bg-gradient-to-r from-blue-400 to-blue-300 rounded-lg p-4 flex items-center justify-between mb-8">
        <div className="text-white text-xl font-semibold mx-4">
          Hello, <span className="text-2xl">{user.firstName || "FName"}!</span>
        </div>
        <img src={Banner} alt="Dashboard Banner" className="w-24 h-auto sm:mr-4" />
      </section>
      ...
      <section className="w-full mb-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <div className="bg-white border border-gray-200 rounded-lg p-4 sm:p-6 h-40 w-full flex flex-col justify-start items-start shadow-md">
            <div className="text-left text-brown-700 text-2xl font-semibold">Phil IRI/CRLA Status</div>
          </div>
          <div className="bg-white border border-gray-200 rounded-lg p-4 sm:p-6 h-40 w-full flex flex-col justify-start items-start shadow-md">
            <div className="text-left text-brown-700 text-2xl font-semibold">RMA</div>
          </div>
        </div>
      </section>
